...
# def dtlz1_objs(dec_vals, num_objs):
#     objectives = [0 for _ in range(num_objs)]
#     num_decs = len(dec_vals)
...
# def dtlz3_objs(dec_vals, num_objs):
#     objectives = [0 for _ in range(num_objs)]
#     num_decs = len(dec_vals)
...
# def dtlz5_objs(dec_vals, num_objs):
#     theta = [0 for _ in range(num_objs)]
#     objectives = [0 for _ in range(num_objs)]
#     num_decs = len(dec_vals)
...
# def dtlz7_objs(dec_vals, num_objs):
#     objectives = [0 for _ in range(num_objs)]
#     num_decs = len(dec_vals)
...
#         val = 0
#         for i in range(0, num_objs - 1):
#             val += (objectives[i] / (1 + g)) * (1 + math.sin(3 * PI * objectives[i]))
#         return num_objs - val
